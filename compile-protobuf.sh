...
protoc --plugin=protoc-gen-ts=./node_modules/.bin/protoc-gen-ts --ts_out=./src/generated -I ./node_modules/devzat/plugin ./node_modules/devzat/plugin/plugin.proto
protoc --descriptor_set_out=./src/generated/plugin-desc.pb -I ./node_modules/devzat/plugin ./node_modules/devzat/plugin/plugin.proto
